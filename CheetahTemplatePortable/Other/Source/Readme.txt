...
user in an INI file next to CheetahTemplatePortable64bit.exe called CheetahTemplatePortable64bit.ini.
...
copy AppNamePortable.ini from this directory to CheetahTemplatePortable64bit.ini next to
CheetahTemplatePortable64bit.exe. The options in the INI file are as follows:
