...
class Backslashes(OutputTest):
    ...
    def tearDown(self):
        if os.path.exists('..\\..\\Data\\CheetahTemplatePortable64bitTemp\\backslashes.txt'):
            os.remove('..\\..\\Data\\CheetahTemplatePortable64bitTemp\\backslashes.txt')
    ...
    def test6(self):
        ...
        self.verify(
            r'#include "..\\..\\Data\\CheetahTemplatePortable64bitTemp\\backslashes.txt"',
            r'\ #LogFormat "%h %l %u %t \"%r\" %>s %b"' + '\n\n\n\n\n\n\n')
...
class IncludeDirective(OutputTest):
    ...
    def setUp(self):
        fp = open('..\\..\\Data\\CheetahTemplatePortable64bitTemp\\parseTest.txt', 'w')
        fp.write("$numOne $numTwo")
        fp.flush()
        fp.close()

    def tearDown(self):
        if os.path.exists('..\\..\\Data\\CheetahTemplatePortable64bitTemp\\parseTest.txt'):
            os.remove('..\\..\\Data\\CheetahTemplatePortable64bitTemp\\parseTest.txt')
    ...
    def test3(self):
        ...
        self.verify("#include raw '..\\..\\Data\\CheetahTemplatePortable64bitTemp\\parseTest.txt'",
                    "$numOne $numTwo")
